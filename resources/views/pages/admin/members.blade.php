                    ...
                    <tr class="hover:bg-slate-50/50 transition-all">
                        ...
                        <td class="px-8 py-6">
                            <div class="flex gap-2">
                                <a href="{{ route('admin.member.pdf', $user) }}" target="_blank" class="p-2 bg-white border border-slate-200 rounded-xl text-gray-400 hover:text-pct-blue hover:border-pct-blue transition-all">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                </a>
                                
                                <form action="{{ route('admin.member.destroy', $user) }}" method="POST" onsubmit="return confirm('ATENÇÃO: Deseja realmente EXCLUIR este membro permanentemente da base nacional? Esta ação não pode ser desfeita.')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="p-2 bg-white border border-slate-200 rounded-xl text-gray-400 hover:text-red-600 hover:border-red-600 transition-all">
