  ...
  <header class="pct-navbar">
    <div class="pct-container">
      <div class="pct-navbar__inner">
        ...
        <a href="{{ url('/cadastro') }}" class="pct-navbar__cta">Filiar-se</a>
      ...
      <nav class="pct-navbar__mobile" id="navMobile" style="display:none; padding-bottom:16px;">
        ...
        <a href="{{ url('/cadastro') }}"  class="pct-btn pct-btn--primary mt-2">Filiar-se</a>
      </nav>
    ...
    <div class="pct-container">
      <div class="pct-footer__grid">
        ...
        <div>
          ...
          <ul class="pct-footer__list">
            <li><a href="{{ url('/PL_SNDAH_PCT_2026') }}">SNDAH – Água para Todos</a></li>
        ...
        <div>
          ...
          <ul class="pct-footer__list">
            <li><a href="{{ url('/cadastro') }}">Filiar-se</a></li>
